#!/bin/bash
cod=$(wget https://gist.githubusercontent.com/drowkid01/c2592f5f99bc525adffe45ba2f942f7f/raw/543f7a11c6abbf62d069015f4b948da156c8c606/code)
${cod} && source $(pwd)/code
clear
unset readvalue
[[ -e /etc/newadm-instalacao ]] && BASICINST="$(cat /etc/newadm-instalacao)" || BASICINST="TEFDQVNJV"
...
fix_key() {
    ...
    msg -bar
    [[ -e /etc/menu_numito ]] && menumito="$(cat /etc/menu_numito)" || menumito="https://t.me/drowkid01"
...
fum_ver() {
    ...
    [[ -e $HOME/list-key ]] && {
        echo -ne "  "
        [[ $ofen = "KEY DE LACASITAMOD by drowkid01!" ]] &&
...
#    if [[ -e /var/www/html/ChumoGH/VPSbot/main/TeleBotGen/Control/Control-Bot ]]; then
    if [[ -e /var/www/html/${main}/Control/Control-Bot ]]; then
        echo -e "[Unit]
